...
namespace DDDNetCore.Migrations
{
    ...
    [Migration("20210117023733_addDriverDuty")]
    partial class addDriverDuty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDDSample1.Domain.DriverDuties.DriverDuty", b =>
                {
                    ...
                    b.HasIndex("mecNumber")
                        .IsUnique()
                        .HasFilter("[mecNumber] IS NOT NULL");
            ...
            modelBuilder.Entity("DDDSample1.Domain.DriverDuties.DriverDuty", b =>
                {
                    b.OwnsOne("DDDSample1.Domain.DriverDuties.DriverDutyType", "type", b1 =>
                        {
                            b1.Property<string>("DriverDutyId")
                                .HasColumnType("nvarchar(450)");

                            b1.Property<string>("type")
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("DriverDutyId");

                            b1.ToTable("DriverDuties");
                    ...
                    b.OwnsMany("DDDSample1.Domain.WorkBlocks.WorkBlockKey", "workBlocks", b1 =>
                        {
                            ...
                            b1.HasKey("DriverDutyId", "Id");

                            b1.ToTable("DriverDuties_workBlocks");
                    ...
                    b.OwnsMany("DDDSample1.Domain.WorkBlocks.WorkBlockKey", "workBlocks", b1 =>
                        {
                            ...
                            b1.ToTable("VehicleDuties_workBlocks");
